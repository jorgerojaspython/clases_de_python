...
titulos = pd.read_csv('E:/01 python/data/titles.csv')
print(titulos.head(10))
elenco = pd.read_csv('E:/01 python/data/cast.csv')
print(len(titulos))
...
print(len( titulos[titulos.year == 2023] ))
...
print(titulos[ titulos.year == 1986].sort_values('title').head(10))
...
c = c[c.year <= 1970]
print (len(c))
# nombres de columnas  o colnames
elenco.columns.tolist()

np.unique(elenco.year)
